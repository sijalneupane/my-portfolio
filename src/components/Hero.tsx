...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen pt-16 flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-blue-900 dark:to-purple-900">
      ...
      <div className="container min-h-full mx-auto px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          {/* Profile Image */}
          <div className="mb-4 inline-block">
            <div className="w-40 h-40 mx-auto bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white text-4xl font-bold shadow-2xl">
              <img
                src={sijal}
                alt="Profile"
          ...
          <h1 className="text-3xl md:text-5xl font-bold leading-tight p-1 mb-7 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent animate-fade-in">
            Flutter, Nest JS & Django, DRF and FastAPI Developer
          </h1>

          <p
            className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-4 leading-relaxed animate-fade-in"
          ...
          >
            ...
            , efficient backend solutions with
            <span className="text-green-600 dark:text-green-400 font-semibold">
              {" "}
              Django and DjangoRestFramework (DRF)
            </span>
            , along with scalable APIs using
          ...
          >
            ...
            <span className="px-4 py-2 bg-teal-100 dark:bg-teal-900/20 text-teal-800 dark:text-teal-300 rounded-full text-sm font-medium">
              FastAPI Developer
            </span>
          </div>
          <div
